...
<head>
    ...
    <link rel="stylesheet" href="../css/final/item_card_styles.css">
...
<?php include 'includes/header.php'; ?>
    ...
    <div id="popup" class="popup">
        <div class="popup-content">
            <span class="close-btn"><img class="header-icon" src="../images/final/assets/x-icon.svg" alt=""></span>
            <img src="../images/final/assets/dragon-logo.png" alt="dragon logo">
    ...
    <script src="../js/final/components/item-card-popup.js"></script>
